	...
	public StudentMain() {
		...
		while (true) {
			...
			case 2:
				...
				Student student = studService.find(sc.nextInt());
				if(student==null) {
			...
			case 3:
				...
				if(upStudent!=null) {
					...
					if(studService.update(upStudent)) {
			...
			case 4:
				System.out.println("Enter Student Id");
				if(studService.delete(sc.nextInt())) {
			...
			case 5:
				...
				Student studentByName = studService.findbyName(sc.next());
